...
char g_WIFI_SSID[20] = "youga_wifi";
char g_WIFI_PASSWORD[20] = "Iot@2018";
...
static int esp8266_close(int fd)
{
	...
	if (QCLOUD_ERR_SUCCESS != ret)	{ //fancyxu
